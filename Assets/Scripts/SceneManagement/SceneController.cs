...
namespace FoxAdventure2d
{
    ...
    public class SceneController : MonoBehaviour
    {
        ...
        protected PlayerPlatformerController m_PlayerPlatformerController;
        ...
        void Awake()
        {
            ...
            m_PlayerPlatformerController = FindObjectOfType<PlayerPlatformerController>();
       ...
       /* public static void RestartZone(bool resetHealth = true)
        ...
        protected IEnumerator Transition(string newSceneName, bool resetInputValues, SceneTransitionDestination.DestinationTag destinationTag, TransitionPoint.TransitionType transitionType = TransitionPoint.TransitionType.DifferentZone)
        {
            ...
            if (m_PlayerPlatformerController == null)
                m_PlayerPlatformerController = FindObjectOfType<PlayerPlatformerController>();
           /* m_PlayerPlatformerController.ReleaseControl(resetInputValues);*/
            yield return StartCoroutine(ScreenFader.FadeSceneOut(ScreenFader.FadeType.Loading));
            PersistentDataManager.ClearPersisters();
            yield return SceneManager.LoadSceneAsync(newSceneName);
            /*m_PlayerPlatformerController = FindObjectOfType<PlayerInput>();
            m_PlayerPlatformerController.ReleaseControl(resetInputValues);*/
           ...
           /* m_PlayerPlatformerController.GainControl();*/
