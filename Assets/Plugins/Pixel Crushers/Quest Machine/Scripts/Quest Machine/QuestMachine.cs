...
namespace PixelCrushers.QuestMachine
{
    ...
    public static class QuestMachine
    {
        ...
        {
            return (!string.IsNullOrEmpty(imageName) && images.ContainsKey(imageName)) ? images[imageName] : null;
        }
        ...
        {
            return (!string.IsNullOrEmpty(audioClipName) && audioClips.ContainsKey(audioClipName)) ? audioClips[audioClipName] : null;
        }
