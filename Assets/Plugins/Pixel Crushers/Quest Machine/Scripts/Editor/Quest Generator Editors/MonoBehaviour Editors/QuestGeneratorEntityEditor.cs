...
namespace PixelCrushers.QuestMachine
{
    ...
    public class QuestGeneratorEntityEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_rewardsUIContents"), true); //rewardsContentGUI.Draw(serializedObject, serializedObject.FindProperty("m_rewardsUIContents"), false);
